public struct GameplayInput
    {
        ...
        public string PowerAInput { get => InputManager.GetInputManagerString(m_Player.ControllerType, InputAction.Button_Shoulder_1, m_Player.ControllerID); }
        public string PowerBInput { get => InputManager.GetInputManagerString(m_Player.ControllerType, InputAction.Button_Shoulder_2, m_Player.ControllerID); }
